...
const DICT: Record<AppLanguage, Record<string, string>> = {
  uk: {
    ...
    favouritePlacesTitle: 'Улюблені',
    favouriteAddTitle: 'Додати улюблене місце',
    favouriteNameLabel: 'Назва',
    favouriteAddressLabel: 'Адреса',
    favouriteDescriptionLabel: 'Опис',
    favouritePhotosLabel: 'Фото (1–5)',
    favouritePhotoUrlPlaceholder: 'Вставте URL фото',
    favouriteAddPhoto: 'Додати фото',
    favouritePhotosHint: 'Ми завантажимо фото і збережемо копію локально.',
    favouritePhotoLimitError: 'Можна додати максимум 5 фото.',
    favouriteMissingPhotos: 'Додайте хоча б одне фото.',
    favouriteMissingFieldsWarning: 'Заповніть назву, адресу й опис.',
    favouritePhotoUrlError: 'Не вдалося завантажити фото за цим URL.',
    favouriteGalleryPermission: 'Дозволь доступ до фотогалереї у налаштуваннях.',
    favouriteAddSuccess: 'Місце збережено в улюблених.',
    favouriteAddFailed: 'Не вдалося зберегти. Спробуйте ще раз.',
    favouriteAddButton: 'Зберегти місце',
    favouriteEmptyTitle: 'Улюблені ще порожні',
    favouriteEmptyHint: 'Додайте перше місце і воно з’явиться тут.',
  },
  en: {
    appName: 'YumMap',
    ...
    favouritePlacesTitle: 'Favourites',
    favouriteAddTitle: 'Add favourite place',
    favouriteNameLabel: 'Name',
    favouriteAddressLabel: 'Address',
    favouriteDescriptionLabel: 'Description',
    favouritePhotosLabel: 'Photos (1–5)',
    favouritePhotoUrlPlaceholder: 'Paste image URL',
    favouriteAddPhoto: 'Add photo',
    favouritePhotosHint: 'We download the image and store a copy.',
    favouritePhotoLimitError: 'You can add up to 5 photos.',
    favouriteMissingPhotos: 'Add at least one photo.',
    favouriteMissingFieldsWarning: 'Fill in name, address, and description.',
    favouritePhotoUrlError: 'Could not download the photo. Check the link.',
    favouriteGalleryPermission: 'Allow access to the photo gallery first.',
    favouriteAddSuccess: 'Saved to favourites.',
    favouriteAddFailed: 'Failed to save the place. Try again.',
    favouriteAddButton: 'Save place',
    favouriteEmptyTitle: 'No favourites yet',
    favouriteEmptyHint: 'Add a place to have it listed here.',
  },
  de: {
    appName: 'YumMap',
    filtersTitle: 'Filter',
    ...
    favouritePlacesTitle: 'Favoriten',
    favouriteAddTitle: 'Favorit hinzufügen',
    favouriteNameLabel: 'Name',
    favouriteAddressLabel: 'Adresse',
    favouriteDescriptionLabel: 'Beschreibung',
    favouritePhotosLabel: 'Fotos (1–5)',
    favouritePhotoUrlPlaceholder: 'Bild-URL einfügen',
    favouriteAddPhoto: 'Foto hinzufügen',
    favouritePhotosHint: 'Wir laden das Bild und speichern eine Kopie.',
    favouritePhotoLimitError: 'Maximal 5 Fotos erlaubt.',
    favouriteMissingPhotos: 'Füge mindestens ein Foto hinzu.',
    favouriteMissingFieldsWarning: 'Name, Adresse und Beschreibung ausfüllen.',
    favouritePhotoUrlError: 'Bild konnte nicht geladen werden. Prüfe den Link.',
    favouriteGalleryPermission: 'Erlauben Sie den Zugriff auf die Fotogalerie.',
    favouriteAddSuccess: 'Favorit gespeichert.',
    favouriteAddFailed: 'Speichern fehlgeschlagen. Nochmals versuchen.',
    favouriteAddButton: 'Ort speichern',
    favouriteEmptyTitle: 'Noch keine Favoriten',
    favouriteEmptyHint: 'Füge einen Ort hinzu, dann erscheint er hier.',
    metersShort: 'm',
  },
  es: {
    appName: 'YumMap',
    ...
    favouritePlacesTitle: 'Favoritos',
    favouriteAddTitle: 'Agregar lugar favorito',
    favouriteNameLabel: 'Nombre',
    favouriteAddressLabel: 'Dirección',
    favouriteDescriptionLabel: 'Descripción',
    favouritePhotosLabel: 'Fotos (1–5)',
    favouritePhotoUrlPlaceholder: 'Pega la URL',
    favouriteAddPhoto: 'Agregar foto',
    favouritePhotosHint: 'Descargamos la imagen y guardamos una copia.',
    favouritePhotoLimitError: 'Puedes subir hasta 5 fotos.',
    favouriteMissingPhotos: 'Agrega al menos una foto.',
    favouriteMissingFieldsWarning: 'Completa nombre, dirección y descripción.',
    favouritePhotoUrlError: 'No pudimos descargar la foto. Revisa el enlace.',
    favouriteGalleryPermission: 'Permite el acceso a la galería primero.',
    favouriteAddSuccess: 'Guardado en favoritos.',
    favouriteAddFailed: 'No se pudo guardar. Intenta de nuevo.',
    favouriteAddButton: 'Guardar lugar',
    favouriteEmptyTitle: 'Aún no hay favoritos',
    favouriteEmptyHint: 'Agrega tu primer lugar para verlo aquí.',
  }
};
